...
const MessageSelector: React.FC<MessageSelectorProps> = ({ onSendMessage, isLoading }) => {
    const [selectedCategory, setSelectedCategory] = useState<string | null>(null);

    const bubbleClasses = "px-4 py-2 rounded-full bg-gray-800/80 text-white text-sm font-semibold hover:bg-gray-700/80 transition-all duration-200 transform hover:scale-105 disabled:bg-gray-900 disabled:text-gray-500 disabled:cursor-wait disabled:scale-100";
