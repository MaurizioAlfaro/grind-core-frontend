...
export const unequipHomunculusItem = (playerState: PlayerState, homunculusId: number, slot: HomunculusEquipmentSlot): EngineResult<{}> => {
    ...
    const existingInvItem = newInventory.find(i => i.itemId === itemIdToUnequip);
    if (existingInvItem) {
