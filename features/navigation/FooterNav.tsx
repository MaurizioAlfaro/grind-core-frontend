...
export type AppView = 'missions' | 'bosses' | 'collection' | 'lab' | 'store' | 'forge' | 'leaderboard' | 'badges' | 'wiki' | 'wizard' | 'settings';
...
export const FooterNav: React.FC<FooterNavProps> = ({ activeView, onNavigate, missionActive, isLabUnlocked }) => {
