...
export const Equipment: React.FC<EquipmentProps> = ({
  ...
  const equipableInventory = inventory.filter(
    (invItem) => ITEMS[invItem.itemId].type === "Equipable"
  );
    ...
    <div className="space-y-6 p-4 bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-700">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2 max-h-60 overflow-y-auto p-2 bg-gray-900/50 rounded-lg">
          {equipableInventory.length > 0 ? (
            equipableInventory.map((invItem) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 p-2 bg-gray-800 rounded-lg border ${
